              ...
              {onCallSorted.map(([name, count]) => {
                ...
                return (
                  <div key={name}>
                    ...
                    >
                      <div className="flex items-center justify-between text-[13px] mb-1">
                        <span className={`transition-colors ${isExpanded ? 'text-[#1D9E75] font-medium' : 'text-[#1A1A2E] group-hover:text-[#1D9E75]'}`}>
                          {isExpanded ? '▼' : '▶'} {name}
                        </span>
                    ...
                    {isExpanded && (
                      <div className="mt-2 mb-1 ml-3 border border-[#E8E8E4] rounded-lg overflow-hidden">
